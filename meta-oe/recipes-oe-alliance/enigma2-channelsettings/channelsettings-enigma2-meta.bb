...
DEPENDS = " \
    ...
    enigma2-plugin-settings-malimali.39e.28e.23e.19e.16e.13e.1w \
    enigma2-plugin-settings-malimali.39e.28e.26e.23e.19e.16e.13e.7e.1w \
    enigma2-plugin-settings-malimali.39e.28e.26e.23e.19e.16e.13e.1w \
    ...
    enigma2-plugin-settings-predrag.28e.23e.19e.16e.13e.7e.5e.1w.4.0w \
    enigma2-plugin-settings-predrag.motor.28e.30w \
    enigma2-plugin-settings-predrag.39e.28e.26e.23e.19e.16e.13e.7.0e.1w.4w \
